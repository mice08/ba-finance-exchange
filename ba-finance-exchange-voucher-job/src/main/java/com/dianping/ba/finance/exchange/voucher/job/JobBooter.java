...
import com.dianping.ba.finance.exchange.voucher.job.NoContractReceiveVoucherController;
...
public class JobBooter {
	...
	private static void startSpring() throws InterruptedException {
        ...
        NoContractReceiveVoucherController controller = (NoContractReceiveVoucherController) appContext.getBean("noContractReceiveVoucherController");
        controller.execute();
	}
