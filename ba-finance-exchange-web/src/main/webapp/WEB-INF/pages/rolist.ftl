        ...
        <div class="tb-wrapper">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th width="10%" class="fs tb-header">客户名</th>
                    <th width="9%" class="fs tb-header">收款方式</th>
                    <th width="9%" class="fs tb-header">到款日期</th>
                    <th width="9%" class="fs tb-header">系统入账日期</th>
                    ...
                    <th width="9%" class="fs tb-header">付款方户名</th>
...
{{if i%2==1}}
    ...
    {{/if}}
        ...
        class="bank-show"  rel="popover">查看</a>
