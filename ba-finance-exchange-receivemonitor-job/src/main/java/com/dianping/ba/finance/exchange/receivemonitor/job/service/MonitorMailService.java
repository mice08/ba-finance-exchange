package com.dianping.ba.finance.exchange.receivemonitor.job.service;
...
public class MonitorMailService {
    ...
    private static final AvatarLogger monitorLogger = AvatarLoggerFactory.getLogger("com.dianping.ba.finance.exchange.receivemonitor.job.service.MonitorMailService");
