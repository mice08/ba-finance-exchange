...
import com.dianping.ba.finance.exchange.biz.utils.ConstantUtils;
...
public class MonitorSmsService {
    private static final AvatarLogger monitorLogger = AvatarLoggerFactory.getLogger("com.dianping.ba.finance.exchange.biz.service.MonitorSmsService");
